...
public class TC004_accounts_id_analystics extends TestBase {
	...
	/*	String responseBody=response.getBody().asString();
		...
		try {
			...
			PrintStream out =new PrintStream(new FileOutputStream("C:\\Users\\ammanrr.CORP\\eclipse-workspace\\RestAssuredAPIAutomation1\\Extracts_Response\\"+s5+"analytics.json"));
